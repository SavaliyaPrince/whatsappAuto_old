...
class groupSelectedModel {
  ...
  static Map<String, dynamic> toMap(groupSelectedModel groupSelectedContactModel) => {
  ...
  static String encode(List<groupSelectedModel> musics) => json.encode(
        musics.map<Map<String, dynamic>>((music) => groupSelectedModel.toMap(music)).toList(),
      );

  static List<groupSelectedModel> decode(String musics) => (json.decode(musics) as List<dynamic>).map<groupSelectedModel>((item) => groupSelectedModel.fromJson(item)).toList();
}
