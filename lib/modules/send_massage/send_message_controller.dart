...
import 'package:whatsapp_auto/modules/send_massage/datasources/country_model.dart';
import 'package:whatsapp_auto/modules/send_massage/datasources/send_message_services.dart';
...
class SendMessageController extends GetxController {
  ...
  String formatMillisecondToDate(int milliSecond) {
    ...
    final String formattedDate =
        DateFormat('d/M/yy h:mm a').format(date).toString();
    String dateTime = "";
